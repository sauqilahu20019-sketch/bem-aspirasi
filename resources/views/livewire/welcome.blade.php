<div>
    ...
    @push('style')
        <style>
            ...
            .pulse-bg {
                /* position: relative; */
                overflow: hidden;
                background: linear-gradient(135deg, #8b5cf6 30%, white 75% 100%);
                background-size: 400% 400%;
                animation: gradientPulse 15s ease infinite, pulseGlow 4s ease-in-out infinite;
            }

            /* Animasi untuk gradient yang bergerak */
            ...
            /* Animasi untuk efek pulse/berdenyut */
            @keyframes pulseGlow {
                0% {
                ...
                <a href="#" class="flex items-center">
                    ...
                    <div class="flex flex-col" style="line-height: 0.75;">
                        <span class="text-lg font-bold text-gray-800 dark:text-white sm:text-xl"
                            style="margin-bottom: -2px;">SIAP BEM</span>
                        <span class="text-xs text-gray-600 dark:text-gray-300 sm:text-sm"
                            style="margin-top: -2px;">Sistem Aspirasi Mahasiswa BEM-KM</span>
                    </div>
                </a>
                <div class="flex items-center lg:order-2">
                    @if (!Auth::user())
                        <flux:button href="{{ route('register') }}" variant="primary" color="indigo" size='sm'>
                            Daftar
                        </flux:button>
                    @endif
    ...
    <section class="bg-white dark:bg-gray-900">
        <div
            class="hero-content grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1
                    class="max-w-xl mb-4 text-2xl font-extrabold leading-none tracking-tight md:text-4xl dark:text-white">
                    Welcome to <span class="text-blue-500">SIAP BEM</span><br>Sistem Informasi Serap Aspirasi Mahasiswa.
                </h1>
                <p
                    class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 items-center md:text-lg lg:text-xl dark:text-gray-400">
                    Universitas Annuqayah.</p>
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    @Auth
                        <a href="{{ route('dashboard') }}"
                            class="inline-flex items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:w-auto">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
            ...
            <div class="floating-img hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="{{ asset('assets/images/garda.png') }}" alt="hero image" width="400">
            </div>
        </div>
    </section>
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Suaramu,
                        Perubahan Kita.</h2>
                    <p class="mb-8 font-light lg:text-xl">Sebagai bentuk komitmen kami dalam mewujudkan kesejahteraan
                        dan keadilan bagi seluruh mahasiswa Universitas Annuqayah, Kementerian Advokasi dan
                        Kesejahteraan Mahasiswa (Adkesma) membuka ruang seluas-luasnya bagi aspirasi, keluhan, dan
                        masukan dari teman-teman mahasiswa.</p>
                    <!-- List -->
                    ...
                    <p class="mb-8 font-light lg:text-xl">Melalui sistem ini, kamu dapat menyampaikan segala bentuk
                        aspirasi terkait perkuliahan, fasilitas kampus, pelayanan akademik, maupun isu-isu lain yang
                        memengaruhi kehidupan kampus kita.</p>
                </div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function createParticle() {
                    ...
                    fade ${duration}s infinite ${delay}s,
                    moveX ${duration * 0.8}s infinite ${delay}s alternate ease-in-out,
                    moveY ${duration}s infinite ${delay}s alternate ease-in-out
                `;
