<main class="p-1 min-w-full mx-auto space-y-6">
    ...
    @endslot
    <flux:fieldset>
        <flux:legend>Daftar Rektor</flux:legend>
        <flux:description>Berikut adalah Data Rektor Universitas Annuqayah.</flux:description>
        <div class="min-h-screen">
            <div class="flex justify-between items-center mb-4 ">
                <div class="flex gap-2">
                    <flux:input type="text" icon="magnifying-glass" kbd="⌘K" wire:model.live="search"
                        placeholder="Cari Rektor..." class="w-full" size="xs" />
                    <div>
                ...
                <flux:modal.trigger name="add-admin" class="mb-4">
                    <div class="flex gap-2">
                        <flux:button icon="plus-circle" size="xs" class="shadow-sm">Tambah Rektor</flux:button>
                    </div>
                </flux:modal.trigger>
            </div>
            ...
            <flux:modal name="add-admin" class="md:w-xl">
                <form wire:submit.prevent="store" class="space-y-6">
                    <div>
                        <flux:heading size="lg">Tambah Rektor</flux:heading>
                        <flux:text class="mt-2">Tambahkan Data Rektor pada Sistem Anda!.</flux:text>
                    </div>
            ...
            <flux:modal name="edit-admin" class="md:w-xl">
                <form wire:submit.prevent="update" class="space-y-6">
                    <div>
                        <flux:heading size="lg">Update Rektor</flux:heading>
                        <flux:text class="mt-2">Ubah Data Rektor pada Sistem Anda!.</flux:text>
                    </div>
