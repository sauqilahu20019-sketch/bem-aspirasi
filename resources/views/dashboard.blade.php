                        ...
                        <div class="flex gap-5">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="flex justify-between items-center mb-4">
                                        ...
                                        <div class="flex space-x-2">
                                            <button class="slider-dot w-2 h-2 rounded-full bg-gray-400"
                                                data-index="0"></button>
                                            <button class="slider-dot w-2 h-2 rounded-full bg-gray-400"
                                                data-index="1"></button>
                                            <button class="slider-dot w-2 h-2 rounded-full bg-gray-400"
                                    ...
                                    <div class="overflow-hidden">
                                        <div id="sliderContainer"
                                            ...
                                            <div class="w-full flex-shrink-0 px-2">
                                                <div
                                                    class="stat-card bg-white border border-gray-200 rounded-xl p-6 fade-in">
                                                    <div class="flex justify-between items-center mb-4">
                                                    ...
                                                    <p class="text-xs text-gray-500 mt-2">Semua aspirasi yang telah dikirim
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full flex-shrink-0 px-2">
                                                <div
                                                    ...
                                                    <p class="text-xs text-gray-500 mt-2">
                                                        {{ $aspTot > 0 ? round(($aspPen / $aspTot) * 100) : 0 }}% dari
                                                        total
                                                        aspirasi</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full flex-shrink-0 px-2">
                                                <div
                                                    ...
                                                    <p class="text-xs text-gray-500 mt-2">
                                                        {{ $aspTot > 0 ? round(($aspAcc / $aspTot) * 100) : 0 }}% dari
                                                        total
                                                        aspirasi</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="w-full flex-shrink-0 px-2">
                                                <div
                                                    ...
                                                    <p class="text-xs text-gray-500 mt-2">
                                                        {{ $aspTot > 0 ? round(($aspRej / $aspTot) * 100) : 0 }}% dari
                                                        total
                                                        aspirasi</p>
                                                </div>
                                            </div>
                            ...
                            <div class="bg-white rounded-lg shadow-md p-6 w-full">
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <a href="{{ route('list.aspirasi') }}"
                                        class="text-sm text-blue-400 hover:text-blue-600">Lihat Semua</a>
                                </div>
                                <div class="space-y-4">
                                    @foreach ($aspirasis as $aspirasi)
                                        <div class="flex items-start border-b pb-3">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="text-sm text-gray-600">Dari: {{ $aspirasi->pengaju->full_name }}
                                                    -
                                                    {{ $aspirasi->pengaju->prodi }}</p>
                                                <p class="text-xs text-gray-500">
                                                    {{ $aspirasi->created_at->diffForHumans() }}
                                                </p>
                                            </div>
                                            <span
                                                class="bg-warning text-white text-xs px-2 py-1 rounded-full">Proses</span>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
