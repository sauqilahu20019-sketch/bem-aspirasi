                                ...
                                <div id="sliderContainer"
                                    ...
                                    <div class="w-full flex-shrink-0 px-2">
                                        <div class="stat-card bg-white border border-gray-200 rounded-xl p-6 fade-in">
                                            ...
                                            <p class="text-xs text-gray-500 mt-2">
                                                {{ $aspTot > 0 ? round(($aspPen / $aspTot) * 100) : 0 }}% dari total
                                                aspirasi</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full flex-shrink-0 px-2">
                                        <div class="stat-card bg-white border border-gray-200 rounded-xl p-6 fade-in">
                                            ...
                                            <p class="text-xs text-gray-500 mt-2">
                                                {{ $aspTot > 0 ? round(($aspAcc / $aspTot) * 100) : 0 }}% dari total
                                                aspirasi</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full flex-shrink-0 px-2">
                                        <div class="stat-card bg-white border border-gray-200 rounded-xl p-6 fade-in">
                                            ...
                                            <p class="text-xs text-gray-500 mt-2">
                                                {{ $aspTot > 0 ? round(($aspRej / $aspTot) * 100) : 0 }}% dari total
                                                aspirasi</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @foreach ($aspirasis as $aspirasi)
                                <div class="flex items-start border-b pb-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-gray-500">{{ $aspirasi->created_at->diffForHumans() }}
                                        </p>
                                    </div>
